...
export default function LoginPage() {
  ...
  const goToSignup = (e: React.MouseEvent) => {
    e.preventDefault();
    setLeaving(true);
    setTimeout(() => router.push("/signup"), 420);
  };
    ...
    <>
      <style>{`
        ...
        * { font-family: 'Sora', sans-serif; }
        ...
        .form-leave  { animation: formOut  0.42s cubic-bezier(0.55,0,1,0.45) both; }
      ...
      <div className="flex min-h-screen w-full">
        ...
        {/* ── LEFT: Blue Panel ── */}
        <div className={`relative flex flex-col justify-between w-[52%] min-h-screen bg-[#2b34d1] px-16 py-14 overflow-hidden ${leaving ? "panel-leave" : "panel-enter"}`}>
        ...
        {/* ── RIGHT: Login Form ── */}
        <div className={`flex flex-col justify-center flex-1 bg-white px-20 py-14 ${leaving ? "form-leave" : "form-enter"}`}>
          ...
          <div className="max-w-sm w-full">
            ...
            <p className="text-sm text-slate-400 mb-10 leading-relaxed">
              ...
              <a href="/signup" onClick={goToSignup} className="text-slate-900 font-semibold underline underline-offset-2 hover:text-blue-600 transition-colors">
            ...
            {/* Login button */}
            <button className="w-full py-4 rounded-xl bg-slate-900 text-white font-semibold text-sm tracking-wide hover:bg-slate-700 active:scale-[0.98] transition-all duration-150 mb-3">
              Login Now
            </button>

            {/* Google button */}
            <button className="w-full py-3.5 rounded-xl border border-slate-200 bg-white text-slate-700 font-medium text-sm flex items-center justify-center gap-3 hover:bg-slate-50 active:scale-[0.98] transition-all duration-150 mb-8">
            ...
            <p className="text-center text-sm text-slate-400">
              Forgot password?{" "}
              <a href="/forgot-password" className="text-slate-900 font-semibold underline underline-offset-2 hover:text-blue-600 transition-colors">
                Click here
              </a>
            </p>
          </div>
